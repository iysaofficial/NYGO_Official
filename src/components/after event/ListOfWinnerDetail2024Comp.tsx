    ...
    return(
        ...
        <section className="low-detail-after-event-section" id="low-detail-after-event">
            <div className="low-detail-after-event-heading">
                <h1 className="section-header">After Event NYGO 2024</h1>
            </div>
            <div className="low-detail-after-event-container">
                <div className="low-detail-after-event-row">
                    ...
                    <div className="low-detail-after-event-video">
                        <iframe className="mt-5"  width="100%" height="315" src="https://www.youtube.com/embed/2xjIXM-T5YA?si=-SIRH9e1H1afSns7" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
                    </div>
            ...
            <div className="low-detail-document-container">
                ...
                <div className="serviceBox">
                    ...
                    <div className="content">
                        ...
                        <br />
                        <Link href="https://drive.google.com/file/d/1u32Uewe64l5nvg_SuDK_RTYeCOxQ8khe/view?usp=sharing" target="_blank" className="low-detail-document-button">Download</Link>
                    </div>
                </div>
                ...
                <div className="serviceBox">
                    ...
                    <div className="content">
                        <h2>Kurasi</h2>
                        <br />
                        <Link href="https://drive.google.com/drive/folders/1BXwAyRnqGS6Pv1jmCezaiRScJEEBj2lf?usp=sharing" target="_blank" className="low-detail-document-button">Download</Link>
                    </div>
                </div>
        ...
        <section className="head-low-detail-document-section" id="head-low-detail-document">
            ...
            <section className="low-press-release-section">
                <div className="low-press-release-container">
                    ...
                    <iframe src="https://drive.google.com/file/d/1NdOFy48a5igVT5h2umhzqrDZujjNRDW1/preview"></iframe>
                    
                    </div>
                </div>
            </section>
            <div className="low-press-release-button-container">
                <Link href="https://drive.google.com/file/d/1NdOFy48a5igVT5h2umhzqrDZujjNRDW1/view?usp=sharing" className="low-press-release-button">Download Press Release</Link>
            </div>
        </section>
        <br />
        </>
