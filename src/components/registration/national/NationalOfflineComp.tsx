...
const NationalOfflineComp: React.FC = () => {
  ...
  useEffect(() => {
    const scriptURL =
      "https://script.google.com/macros/s/AKfycbwfwn0VMMRamMR29EDTUQTEKGDYxGuwA7L2s6Q9Kg5oXXndyiLQYVocUCQMT8zIUtrOGw/exec";
...
const HeaderSection: React.FC = () => (
  <div className="header-section">
    <div className="header-content">
      ...
      <h2 className="event-title">NYGO 2026</h2>
    </div>
  </div>
);
...
const InstructionSection: React.FC = () => (
  <div className="instruction-section">
    <h3 className="instruction-title">
      HALLO PESERTA NYGO 2026, Mohon perhatikan informasi berikut ini sebelum mengisi formulir pendaftaran:
    </h3>
...
const InformasiUmumSection: React.FC = () => (
  <section className="form-section">
    ...
    <div className="field-grid">
      ...
      <div className="field-group">
        <label className="field-label">Sumber Informasi Kompetisi NYGO 2026</label>
